...
在[第三篇](https://blog.holbertonschool.com/hack-the-virtual-memory-drawing-the-vm-diagram/)文章中，我们将探索虚拟内存的更多细节，并且看下虚拟内存中都有些什么， 以及这些东西分别位于虚拟内存的什么地方。  
...
![虚拟内存示意图](https://github.com/sigusr1/sigusr1.github.io/blob/master/picture/virtual_memory/virtual_memory.png)
