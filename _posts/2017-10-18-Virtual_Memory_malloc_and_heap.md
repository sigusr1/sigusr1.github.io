...
![](http://34.210.34.184:8888/blog/virtual_memory/program-break-before.png)

`malloc`通过调用`brk`或`sbrk`增加`program break`的值，从而创建可以通过`malloc`动态分配的内存空间。所以堆是进程的数据段的延伸。  
![](http://34.210.34.184:8888/blog/virtual_memory/program-break-after.png)
...
![](http://34.210.34.184:8888/blog/virtual_memory/0x10-malloc.png)
...
![](http://34.210.34.184:8888/blog/virtual_memory/malloc-chunk.png)
